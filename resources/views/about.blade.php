...
@section('content')
	<article class="about">
		<img src="//storage.googleapis.com/sca/mja/profile-placeholder.jpg" alt="Mrs. Melissa Alvarez Mangual">
		...
		<ul>
			<li class="icon-pen">International Leadership Association</li>
			<li class="icon-pen">Center for Creative Leadership</li>
			<li class="icon-pen">Human Capital Institute: The Global Association for Strategic Talent Management</li>
			<li class="icon-pen">ATD: Association for Talent Development</li>
			<li class="icon-pen">The eLearning Guild</li>
		</ul>
