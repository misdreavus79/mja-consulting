...
@section('content')
	...
	<p>Custom programs designed around your intake assessment, your stated fitness objective, and the duration of time necessary to bridge the two. Types of training include one-on-one, two-on-one, pre- and post-natal, and rehabilitative training.</p>

	<a href="training/personal/">Learn More</a>
	...
	<a href="training/group/">Learn More</a>
	...
	<a href="training/online/">Learn More</a>
	...
	<p>Remember, food is fuel for the body’s every process whether it is to simply manage your daily activities of work/school or your performance in a sport event.</p>

	<a href="nutrition">Learn More</a>

	<h2>Youth Training</h2>
	<p>Description necessary.</p>

	<a href="training/youth/">Learn More</a>
@endsection
